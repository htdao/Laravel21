        ...
        <div class="col-12 col-sm-6 col-lg-4 mb-30">
          <div class="footer-widget">
            ...
            <div class="nletter-form mb-35">
              <form class="form-inline position-relative" action="http://devitems.us11.list-manage.com/subscribe/post?u=6bbb9b6f5827bd842d9640c82&amp;id=05d85f18ef" target="_blank" method="post">
      ...
      <div class="row">
        ...
        <div class="col-12 col-md-6 col-xl-8">
          <div class="text-md-right text-center">
            <img src="images/1_1.png" alt="img">
          </div>
        </div>
      </div>
    </div>
