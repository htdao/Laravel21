@extends('frontend.layouts.master')
  ...
  Create an account
      ...
      <section class="register-form">
        <p>Already have an account? <a href="https://apollotran.com/prestashop/leo_cosmetics/en/login">Log in instead!</a></p>
        
  
      

<form action="https://apollotran.com/prestashop/leo_cosmetics/en/login?create_account=1" id="customer-form" class="js-customer-form" method="post">
  <section>
