            ...
            <div class="row grid-view theme1">
                ...
                <div class="card product-card">
                  <div class="card-body">
                    <div class="product-thumbnail position-relative">
                      ...
                      <a href="single-product.html">
                        <img class="first-img" src="images/6.png" alt="thumbnail">
                      </a>
                      <!-- product links -->
                      <ul class="actions d-flex justify-content-center">
                        <li>
                ...
                <div class="card product-card">
                  <div class="card-body">
                    <div class="product-thumbnail position-relative">
                      ...
                      <a href="single-product.html">
                        <img class="first-img" src="images/2_1.png" alt="thumbnail">
                      </a>
                      <!-- product links -->
                      <ul class="actions d-flex justify-content-center">
                        <li>
                    ...
                    <div class="product-desc py-0 px-0">
                      <h3 class="title">
                        <a href="shop-grid-4-column.html">New Balance Fresh Cream Kaymin from new zeland</a>
                      </h3>
                      <div class="star-rating">
                        <span class="ion-ios-star"></span>
                        <span class="ion-ios-star"></span>
                ...
                <div class="card product-card">
                  <div class="card-body">
                    <div class="product-thumbnail position-relative">
                      <span class="badge badge-danger top-right">New</span>
                      <a href="single-product.html">
                        <img class="first-img" src="images/7.png" alt="thumbnail">
                      </a>
                      <!-- product links -->
                      <ul class="actions d-flex justify-content-center">
                        <li>
                    ...
                    <div class="product-desc py-0 px-0">
                      <h3 class="title">
                        <a href="shop-grid-4-column.html">orginal Kaval Windbreaker Winter cream</a>
                      </h3>
                      <div class="star-rating">
                        <span class="ion-ios-star"></span>
                        <span class="ion-ios-star"></span>
              ...
              <div class="col-sm-6 col-lg-4 mb-30">
                <div class="card product-card">
                  <div class="card-body">
                    ...
                    <div class="product-desc py-0 px-0">
                      <h3 class="title">
                        <a href="shop-grid-4-column.html">Juicy Couture Tricot Logo Stripe Face Cream</a>
                      </h3>
                      <div class="star-rating">
                        <span class="ion-ios-star"></span>
                        <span class="ion-ios-star"></span>
              ...
              <div class="col-sm-6 col-lg-4 mb-30">
                <div class="card product-card">
                  <div class="card-body">
                    ...
                    <div class="product-desc py-0 px-0">
                      <h3 class="title">
                        <a href="shop-grid-4-column.html">orginal Kaval Windbreaker Winter Face Cream</a>
                      </h3>
                      <div class="star-rating">
                        <span class="ion-ios-star"></span>
                        <span class="ion-ios-star"></span>
                ...
                <div class="card product-card">
                  <div class="card-body">
                    <div class="product-thumbnail position-relative">
                      <span class="badge badge-danger top-right">New</span>
                      <a href="single-product.html">
                        <img class="first-img" src="images/4.png" alt="thumbnail">
                        <img class="second-img" src="images/12.png" alt="thumbnail">
                      </a>
                      <!-- product links -->
                      <ul class="actions d-flex justify-content-center">
                        <li>
              ...
              <div class="col-sm-6 col-lg-4 mb-30">
                <div class="card product-card">
                  <div class="card-body">
                    <div class="product-thumbnail position-relative">
                      <span class="badge badge-danger top-right">new arrivals</span>
                      <a href="single-product.html">
                        <img class="first-img" src="images/5_1.png" alt="thumbnail">
                        <img class="second-img" src="images/12.png" alt="thumbnail">
                      </a>
                      <!-- product links -->
                      <ul class="actions d-flex justify-content-center">
                  ...
                  <div class="card-body">
                    <div class="product-thumbnail position-relative">
                      ...
                      <a href="single-product.html">
                        ...
                        <img class="second-img" src="images/5_1.png" alt="thumbnail">
                      </a>
                      <!-- product links -->
                      <ul class="actions d-flex justify-content-center">
                        <li>
                  ...
                  <div class="card-body">
                    <div class="product-thumbnail position-relative">
                      ...
                      <a href="single-product.html">
                        ...
                        <img class="second-img" src="images/8.png" alt="thumbnail">
                      </a>
                      <!-- product links -->
                      <ul class="actions d-flex justify-content-center">
                        <li>
        ...
        <aside class="left-sidebar theme1">
          ...
          <div class="banner hover-animation position-relative overflow-hidden">
            <a href="shop-grid-4-column.html" class="d-block">
              <img src="images/2_2.jpg" alt="img">
            </a>
          </div>
          <!--second banner end-->
        </aside>
